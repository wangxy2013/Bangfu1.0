 ...
 * 描述：农户->基本信息
 */
public class FamilyListActivity extends BaseActivity implements PullToRefreshBase.OnRefreshListener<RecyclerView>, IRequestListener
{
    ...
    private BaseHandler mHandler = new BaseHandler(this)
    {
        ...
        public void handleMessage(Message msg)
        {
            ...
            switch (msg.what)
            {
                ...
                case REQUEST_FAIL:
                    ToastUtil.show(FamilyListActivity.this, msg.obj.toString());
                    break;
    ...
    {
        setContentView(R.layout.activity_famliy_list);
    ...
    protected void initViewData()
    {
        ...
        emptyDecoration = new EmptyDecoration(FamilyListActivity.this, "");
        mRecyclerView.addItemDecoration(emptyDecoration);
        LinearLayoutManager mLinearLayoutManager = new LinearLayoutManager(FamilyListActivity.this, LinearLayoutManager.VERTICAL, false);
        //mLinearLayoutManager.setStackFromEnd(true);
        mRecyclerView.setLayoutManager(mLinearLayoutManager);
        mFarmerInfomationAdapter = new FarmerInfomationAdapter(mUserInfoList, FamilyListActivity.this, new MyItemClickListener()
        {
            @Override
            public void onItemClick(View view, int position)
            {

                Intent intent = new Intent(FamilyListActivity.this, FarmerInformationActivity.class);
        ...
        }, new MyItemClickListener()
        {
            ...
            {
                //修改操作
                Intent intent = new Intent(FamilyListActivity.this, AddHolderActivity.class);
                Bundle b = new Bundle();
    ...
    private void getUserInfoList()
    {
        ...
        DataRequest.instance().request(FamilyListActivity.this, Urls.getHolderInfoListUrl(), this, HttpRequest.POST, GET_USERINFO_LIST, valuePairs,
    ...
    public void onClick(View v)
    {
        ...
        switch (v.getId())
        {
            ...
            case tv_submit:
                startActivity(new Intent(FamilyListActivity.this, AddHolderActivity.class).putExtra("relationType", "1").putExtra("TYPE", "1"));
                break;

            case R.id.rl_search:
                startActivity(new Intent(FamilyListActivity.this, SearchHolderActivity.class));
                break;
        }
    }
