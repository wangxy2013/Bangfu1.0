 ...
 * 描述：教育救助信息
 */
public class EduListActivity extends BaseActivity implements PullToRefreshBase.OnRefreshListener<RecyclerView>, IRequestListener
{
    ...
    private BaseHandler mHandler = new BaseHandler(this)
    {
        ...
        public void handleMessage(Message msg)
        {
            ...
            switch (msg.what)
            {
                ...
                case REQUEST_FAIL:
                    ToastUtil.show(EduListActivity.this, msg.obj.toString());
                    break;
    ...
    protected void initViewData()
    {
        ...
        emptyDecoration = new EmptyDecoration(EduListActivity.this, "");
        mRecyclerView.addItemDecoration(emptyDecoration);
        LinearLayoutManager mLinearLayoutManager = new LinearLayoutManager(EduListActivity.this, LinearLayoutManager.VERTICAL, false);
        //mLinearLayoutManager.setStackFromEnd(true);
        mRecyclerView.setLayoutManager(mLinearLayoutManager);
        mEduAdapter = new EduAdapter(mEduAssistInfoList, EduListActivity.this, new MyItemClickListener()
        {
            @Override
            public void onItemClick(View view, int position)
            {

                Intent intent = new Intent(EduListActivity.this, InputEducationActivity.class);
                Bundle b = new Bundle();
    ...
    private void getHtyList()
    {
        ...
        DataRequest.instance().request(EduListActivity.this, Urls.getEduInfoListUrl(), this, HttpRequest.POST, GET_LIST, valuePairs,
                new EduListHandler());
    }
    ...
    public void onClick(View v)
    {
        ...
        switch (v.getId())
        {
            ...
            case R.id.tv_submit:
                startActivity(new Intent(EduListActivity.this, InputEducationActivity.class).putExtra("TYPE", "1"));
                break;

            case R.id.rl_search:
                startActivity(new Intent(EduListActivity.this, SearchEduActivity.class));
                break;
        }
    }
