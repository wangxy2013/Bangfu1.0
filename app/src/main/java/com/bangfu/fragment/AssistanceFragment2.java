...
import com.bangfu.activity.VisitEvaluationActivity;
 ...
 * 描述：特别援助->待处理
 */
public class AssistanceFragment2 extends BaseFragment implements PullToRefreshBase.OnRefreshListener<RecyclerView>, IRequestListener
{
    ...
    public static AssistanceFragment2 newInstance(String type)
    {
        Bundle args = new Bundle();
        args.putString("type", type);
        AssistanceFragment2 fragment = new AssistanceFragment2();
